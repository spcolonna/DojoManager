                ...
                if (state.error != null) ...[
                  Container(
                    ...
                    decoration: BoxDecoration(
                      color: const Color(0xFF7B241C).withOpacity(0.3),
                      borderRadius: BorderRadius.circular(8),
                      border: Border.all(
                        color: const Color(0xFFC0392B).withOpacity(0.5),
                      ),
                    ),
                    child: Row(
                      children: [
                    ...
                    child: RichText(
                      text: TextSpan(
                        ...
                        children: [
                          ...
                          TextSpan(
                            text: isLogin ? loc.loginSignUp : loc.loginLogIn,
